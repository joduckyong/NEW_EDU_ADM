...
var gpkiScriptBase   = '/js/egovframework/client';     // * 스크립트에서 사용하는 클라이언트 모듈의 기본 경로 (var.js의 경로)
///gpkisecureweb/client
var clientModulePath = '/gpkisecureweb/client/setup';	// * 클라이언트 설치 파일의 게시 경로. (cab, exe, dmg, rpm, deb)

var ClientInstallPage   = '/gpkisecureweb/install.html';    // * 설치 페이지 경로
var ServiceStartPageURL = '/ncts/login/egovLoginForm.do';      // * 설치완료후 이동할 페이지
...
var verActiveX     = '1,0,1,6';				// * ActiveX 클라이언트 버전. 버전 정보는 ','로 자리 구분.
...
var ServerCert     = ''
...
function getBrowserPlatform()
{
	...
	if (window.navigator.platform.toLowerCase().indexOf('linux') > -1) {  // originally Linux
...
function checkBrowserVersion(){
	...
	}else if(browserInfo.name.toLowerCase() == "chrome"){
		if(browserInfo.version > 44){
			return false;
		}
	}
	return true;
...
console.log(SetupOffLineFilePath);
