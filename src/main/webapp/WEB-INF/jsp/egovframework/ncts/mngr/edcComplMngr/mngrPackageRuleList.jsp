...
<script type="text/javascript">
	$(function(){
	    ...
	    $.dataDetail = function(index, obj){
	        ...
	        document.sForm.packageRuleNo.value = index;
	        
	        $.ajax({
	            type: 'POST',
	            url: "/ncts/mngr/edcComplMngr/mngrPackageRuleDetail.do",
	...
	<section id="widget-grid" class="">
		...
		<div class="search">
          	<form name="sForm" id="sForm" method="post">
                <input type="hidden" name="packageRuleNo" id="packageRuleNo" value=0>
                <div class="fL wp70">
...
<tr>
	...
	<td colspan="3">{{PACKAGE_RULE_NM}}</td>
</tr>
</script>