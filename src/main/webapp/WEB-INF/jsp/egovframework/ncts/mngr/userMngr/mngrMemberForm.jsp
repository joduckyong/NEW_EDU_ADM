						        ...
						        <tr>
                                    ...
                                    <td colspan = "3">
                                        <label class="input w250 col"> <i class="icon-append fa fa-calendar"></i>
                                            <input type="text" class="date inputcal" id="userBirthYmd" name="userBirthYmd" value="${result.USER_BIRTH_YMD}" ${not empty result.USER_BIRTH_YMD ? 'readonly':''  }/>
                                        </label>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <c:choose>
	                                    <c:when test="${ common.procType eq common.baseType[1].key()  }">
	                                    	...
	                                    	<td>
	                                   	    	<label class="input w250 col">
	                                    	        <input type="text" id="userHpNo" name="userHpNo" value="${result.USER_HP_NO }" maxlength="13" ${not empty result.USER_HP_NO ? 'readonly':''  }>
	                                    	    </label>
	                                    	</td>
	                                    	<th>첨부파일</th>
                                   	 		<td>
