...
$(function(){
	...
	$.dataDetail = function(index){
		...
		$("input[name='eduDivision']").val(obj.packageGubun);
		
		$.ajax({
			type: 'POST',
			url: "/ncts/mngr/eduReqstMngr/selectMngrDtyEduDetail.do",
			data: $("#sForm").serialize(),
			dataType: "json",
			success: function(data) {
				if(data.success == "success"){
					document.ubiForm.actStatus.value = data.rs.INSTRCTR_ACT_AT;
	...
	$.instrctrOthbcYn = function(val){
        ...
        $.ajax({
        	type: 'POST',
            url: "/ncts/mngr/eduReqstMngr/updateDtyInstrctrOthbcYnProcess.do",
            data			: {
				"eduSeq" : $("#eduSeq").val(),
...
<form id="ubiForm" name="ubiForm" method="post">
	...
	<input type="hidden" name="eduDivision" value="" />
</form>
