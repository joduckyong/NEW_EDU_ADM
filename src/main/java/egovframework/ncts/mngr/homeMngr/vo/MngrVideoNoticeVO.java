...
public class MngrVideoNoticeVO extends CommonVO{
    private int bbsNo;
    private String bbsTypeCd;
    private String bbsTypeDetailCd;
    ...
    public String getBbsTypeDetailCd() {
        return bbsTypeDetailCd;
    }
    public void setBbsTypeDetailCd(String bbsTypeDetailCd) {
        this.bbsTypeDetailCd = bbsTypeDetailCd;
    }
