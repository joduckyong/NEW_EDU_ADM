...
public class EgovNctsMngrLctreVideoController {
    /** log */
    private static final Logger LOGGER = LoggerFactory.getLogger(EgovNctsMngrLctreVideoController.class);
    ...
    @PreAuth(menuCd="110140101", pageType=PageType.LIST)
    @RequestMapping(value = "/mngrLctreVideoList.do")
    public String mngrLctreVideoList (HttpServletRequest request, ModelMap model,@ModelAttribute("common") MngrLctreOffVO param, @ModelAttribute("paginationInfo") PageInfoVO pageVO) throws Exception {
