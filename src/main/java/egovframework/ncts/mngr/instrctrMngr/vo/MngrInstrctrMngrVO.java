...
public class MngrInstrctrMngrVO extends CommonVO{
    private int userNo;
    ...
    private String instrctrStatus;
    private String orgInstrctrStatus;
	...
	public String getInstrctrStatus() {
		return instrctrStatus;
	}
	public void setInstrctrStatus(String instrctrStatus) {
		this.instrctrStatus = instrctrStatus;
	}
	public String getOrgInstrctrStatus() {
		return orgInstrctrStatus;
	}
	public void setOrgInstrctrStatus(String orgInstrctrStatus) {
		this.orgInstrctrStatus = orgInstrctrStatus;
	}
